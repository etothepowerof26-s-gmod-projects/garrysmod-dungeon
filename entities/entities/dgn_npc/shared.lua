...
ENT.VoiceLines = {
    ["male"] = {
        ["talk"] = {"vo/npc/male01/hi01.wav", "vo/npc/male01/hi02.wav"},
        ["hurt"] = {"vo/trainyard/male01/cit_hit01.wav", "vo/trainyard/male01/cit_hit02.wav", "vo/trainyard/male01/cit_hit03.wav", "vo/trainyard/male01/cit_hit04.wav", "vo/trainyard/male01/cit_hit05.wav"}
    },
    ["female"] = {
        ["talk"] = {"vo/npc/female01/hi01.wav", "vo/npc/female01/hi02.wav"},
        ["hurt"] = {"vo/trainyard/female01/cit_hit01.wav", "vo/trainyard/female01/cit_hit02.wav", "vo/trainyard/female01/cit_hit03.wav", "vo/trainyard/female01/cit_hit04.wav", "vo/trainyard/female01/cit_hit05.wav"}
    }
}
...
function ENT:GetGender()
    ...
    if self.GenderTable[mdl] then return self.GenderTable[mdl] end
